...
class Food:
    ...
    def changelocation(self):
        # Haven't programmed it to spawn outside the snake's body yet
...
class Snake:
    def __init__(self):
        ...
        self.nextY = 0
        self.crashed = False  # Use this when I get around to collision detection
    ...
    def moveOneStep(self):
        if Square(self.nextposition[0], self.nextposition[1]) not in self.body: 
            ...
            self.crashed = True  # Collision detection?

    def moveup(self):  # Obvious
